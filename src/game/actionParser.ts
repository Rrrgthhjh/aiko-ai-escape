...
const MOOD_ACTION_KEYWORDS: Partial<Record<Mood, Array<[string, number?]>>> = {
  ...
  happySlight: [
    ...
    ["sorriso tímido no canto", 9], ["um sorrisinho", 9], ["sorrisinho", 8],
    ["sorri um pouco", 9], ["quase sorri", 9], ["um traço de sorriso", 9],
    ["half smile", 9], ["tiny smile", 9], ["smiles a little", 9],
  ],
  blushLight: [
    ...
    ["cheeks tinge pink", 9],
    ["cora sem querer", 9], ["um rosa suave nas bochechas", 9],
    ["fica levemente vermelha", 9], ["cora discretamente", 9],
    ["light blush", 9], ["cheeks turn slightly pink", 9],
  ],
  tearSingle: [
    ...
    ["uma lágrima silenciosa", 10], ["uma lágrima desliza", 10],
    ["enxuga uma lágrima", 10], ["uma lágrima escapa", 10],
    ["one tear rolls down", 10], ["a tear slips", 10],
  ],
  angrySlight: [
    ...
    ["resmunga", 8], ["murmura irritada", 9], ["dá de ombros irritada", 9],
    ["faz bico", 8], ["emburrada", 8], ["amuada", 8], ["contrariada", 8],
    ["pouts", 8], ["huffs", 8], ["rolls her eyes", 8],
  ],
  shy: [
    ...
    ["vergonha", 4], ["envergonhada", 5], ["constrangid", 4], ["sem graça", 3],
    ["brinca com os dedos", 4], ["torce as mãos", 4],
    ["fala baixinho envergonhada", 6], ["cobre o rosto", 5], ["olha de relance", 3],
    ["bashful", 4], ["embarrassed", 4], ["flustered", 5], ["looks away shyly", 6],
    ["fidgets", 4], ["stammers", 4],
  ],
  blush: [
    ...
    ["vermelha como um tomate", 8], ["pescoço fica vermelho", 7],
    ["não consegue olhar nos seus olhos", 6], ["explode de vergonha", 7],
    ["beet red", 7], ["face burns", 7], ["turns bright red", 7],
  ],
  flirty: [
    ...
    ["dá um sorrisinho safado", 7], ["ergue uma sobrancelha", 5],
    ["chega bem perto", 5], ["puxa você pela gola", 6], ["se insinua", 6],
    ["provocativa", 5], ["flirty", 5], ["seductive", 6],
    ["bites her lip", 6], ["leans in close", 5],
  ],
  scared: [
    ...
    ["se assusta", 5], ["leva um susto", 5], ["fica sem reação de medo", 6],
    ["abraça os próprios braços", 4], ["corpo treme", 5], ["voz trêmula", 5],
    ["olha em volta nervosa", 4], ["terrified", 6], ["frightened", 5], ["flinches", 5],
  ],
  sleepy: [
    ...
    ["encosta a cabeça no seu ombro", 6], ["pisca devagar", 5],
    ["quase dormindo", 6], ["morta de sono", 6], ["exausta", 5], ["cansada", 4],
    ["tired", 4], ["drowsy", 5], ["nods off", 6],
  ],
  happy: [
    ...
    ["sorri de orelha a orelha", 5], ["dá pulinhos", 5], ["comemora", 4],
    ["olhos brilhando", 4], ["toda animada", 5], ["cheia de energia", 4],
    ["não para de sorrir", 5], ["felicidade", 4], ["eufóri", 5], ["adorou", 4],
    ["ri baixinho", 4], ["giggles", 4], ["chuckles", 4], ["excited", 4], ["cheerful", 4],
  ],
  sad: [
    ...
    ["fica quieta", 3], ["abaixa a cabeça", 4], ["voz falha", 4],
    ["aperta o peito", 4], ["decepcionada", 4], ["frustrada", 3],
    ["um nó na garganta", 5], ["solitária", 4],
    ["downcast", 4], ["gloomy", 4], ["disappointed", 4],
  ],
  crying: [
    ...
    ["não segura o choro", 6], ["se debulha em lágrimas", 6], ["funga", 5],
    ["olhos cheios d'água", 6], ["chorando muito", 6], ["weeps", 5],
    ["tears stream", 6], ["bursts into tears", 6],
  ],
  angry: [
    ...
    ["explode de raiva", 6], ["berra", 5], ["fica furiosa", 6], ["perde a paciência", 5],
    ["bate o pé", 5], ["empurra você", 5], ["fala entre dentes", 5], ["indignada", 4],
    ["revoltada", 5], ["ódio", 5], ["furious", 5], ["yells", 4], ["snaps", 4],
  ],
  surprised: [
    ...
    ["não acredita", 4], ["fica congelada", 4], ["dá um pulo", 4],
    ["cobre a boca surpresa", 5], ["perplexa", 4], ["atônita", 5], ["de queixo caído", 5],
    ["astonished", 4], ["stunned", 4], ["startled", 4],
  ],
  tense: [
    ...
    ["fica na defensiva", 5], ["cruza os braços", 3], ["evita o assunto", 4],
    ["respira fundo", 3], ["fica em silêncio", 3], ["desconforto", 4],
    ["uneasy", 4], ["tense", 4], ["nervous", 4], ["hesitates", 3],
  ],
  soft: [
    ...
    ["segura sua mão", 4], ["encosta a testa na sua", 5], ["cafuné", 5],
    ["se aconchega", 5], ["olhar doce", 4], ["docemente", 4], ["te acolhe", 4],
    ["gently", 3], ["tenderly", 4], ["cuddles", 4], ["hugs", 4],
  ],
  hopeful: [
    ["olha esperançosa", 5], ["respira aliviada", 5], ["sorri esperançosa", 5],
    ["esperançosa", 4], ["aliviada", 4], ["com esperança", 4],
    ["solta o ar aliviada", 5], ["um brilho de esperança", 5], ["se anima de novo", 5],
    ["relieved", 4], ["hopeful", 4],
  ],
};
